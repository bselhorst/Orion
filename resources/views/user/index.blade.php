            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-header">
                        <h4 class="header-title">Tabela de Usuários</h4>
                        @can($permission.'.create')
                            <a href="{{url()->current()}}/create" class="btn btn-success btn-create">Cadastrar</a>
                        @endcan
                    </div>
                    <p class="text-muted fs-14">
                        Abaixo a tabela de todos os usuários do sistema.
                    </p>
                                        ...
                                        <td>
                                            @can($permission.'.update')
                                                <div style="display: inline-block;" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="primary-tooltip" data-bs-title="Permissões">
                                                    <a href="{{url()->current()}}/perfil/{{$item->id}}" class="text-reset px-1" style="font-size: 20px"> <i class="ri-admin-fill"></i></a>
                                                </div>
